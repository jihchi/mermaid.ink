...
If you run into a core dump error during startup (see [#496](https://github.com/jihchi/mermaid.ink/issues/496) for more details), you might want to run it without default seccomp profile.
...
| `QUEUE_CONCURRENCY`    | `1`           | Sets the maximum number of concurrent rendering jobs.                                                                                                                                                                                                                                                                                                                                                                                             |
| `QUEUE_ADD_TIMEOUT`    | `3000`        | Defines the timeout duration (in milliseconds) for a rendering job.                                                                                                                                                                                                                                                                                                                                                                               |
| `ENABLE_DATABASE`      | `<unset>`     | Enable PostgreSQL database caching. Set to `'true'` to enable, otherwise it's disabled.                                                                                                                                                                                                                                                                                                                                                           |
| `PGHOST`               | `<unset>`     | PostgreSQL server hostname. For example: `'localhost'`.                                                                                                                                                                                                                                                                                                                                                                                           |
| `PGPORT`               | `<unset>`     | PostgreSQL server port. For example: `5432`.                                                                                                                                                                                                                                                                                                                                                                                                      |
| `PGDATABASE`           | `<unset>`     | PostgreSQL database name. For example: `'postgres'`.                                                                                                                                                                                                                                                                                                                                                                                              |
| `PGUSERNAME`           | `<unset>`     | PostgreSQL username. For example: `'postgres'`.                                                                                                                                                                                                                                                                                                                                                                                                   |
...
- If running via docker, use [`NODE_OPTIONS`](https://nodejs.org/api/cli.html#cli_node_options_options) to increase `--max-http-header-size`
  - e.g. `docker run --rm -it -e 'NODE_OPTIONS="--max-http-header-size=102400000"' -p 3000:3000 ghcr.io/jihchi/mermaid.ink`
